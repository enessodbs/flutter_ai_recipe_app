              ...
              const Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 10),
                    Text("Welcome to the app!", style: TextStyle(color: Colors.white, fontSize: 18)),
                  ],
                ),
              ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                          ...
                          onPressed: () async {
                            try {
                              if (password.text == rpassword.text) {
                                await _authService.registerWithEmailAndPassword(email.text, password.text);
                        ...
                        const Text("Continue with Google", style: TextStyle(color: Colors.grey)),
                        const SizedBox(height: 30),
                        Row(
                          children: <Widget>[
                            Expanded(
